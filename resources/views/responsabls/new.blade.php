...
<div class="toll">
	...
	<form  action="{{ route('SaveResp') }}" method="POST" class="form-horizontal" name="formulario"onsubmit="return confirm('¿Realmente desea enviar el formulario?');">
			  {{ csrf_field() }}
	...
	<div>
		<a href="{{ route('cursos') }}" ><img src="{{ asset('images/irAtras.jpg') }}" title="Volver" class="irAtras" align="left"></a>  
	</div>
</div>
