...
<div  class="cont">		
	<div class="IrHome" style="margin-top:2%;">
		<a href="{{ route('welcome') }}" title="Inicio" >
			<img src="{{ Storage::url("images/inicio.png")}}" width="100" height="120">
		</a>
	</div>		
	<div  class="container-app"  >
	 ...
	 <div class="bar-left" > 
		 <div style="font-size:1.5rem; display:flex;"> 
		       @if (Auth::user())  
			  ...
			  @else 
				<a href="{{ route('login') }}"  style="color:#0000FF;"> 
					<img src="{{asset('images/acceso.png')}}">Acceder
				</a> 
			 @endif   		    	
		</div>
