		...
		<tbody>			
			<tr>
				...
				<td class="display-5 text-center" style="display: flex;">{{$curso->inscs_count}}
					<small style="font-size: 1rem; height: auto;width: 60%; color: red;"><i>'¿pueden haber aspirantes sin confirmar?',</i> pinche para confirmar</small>	
				...
				<!-- 	<img src="{{asset ('images/icons/ver.png')}}" wire:click="show({{ $curso->id }})" class="all-scroll" width="20">	 -->
					...
					<img src="{{asset ('images/icons/ver.png')}}" wire:click="pdf({{ $curso->id }})" class="all-scroll" width="20">				
