...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      mensaje: 'Mensaje dinamico'
    };
  },
  methods: {
    mostarMensaje: function mostarMensaje() {
      return this.mensaje;
    },
...
// module
exports.push([module.i, "\n#inicio{\n\tmargin-top:20px;\n\tmargin-right:5%;\n}\n.tite{ font-size: 36px; \n\tcolor: #00558d; \n\ttext-align:center; \n\tfont-family: fantasy;\n\tmargin-top:5%;}\n.tite2{\n\tcolor:#FF7A00; \n\tfont-size: 36px; \n\tfont-family: fantasy;}\n.H-Ast{font-size:40px; text-align:center; margin-left:10%; margin-right:10%; margin-top:5%;}\np { \n\ttext-align: justify;\n\tfont-size:24px;\n\tline-height:1.5;\n\tpadding-left:2%;\n\tpadding-right:2%\n}\n.p-2{\n\tfont-size:30px;\n\t padding-left:10%; \n\t padding-right:10%; \n\t padding-top:0; \n\t top:0; \n\t font-style:oblique;\n}\n\n\n", ""]);
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", [
      _c("div", { staticStyle: { display: "flex", "margin-right": "5%" } }, [
        _c("div", [
          _c("img", { attrs: { src: "storage/images/logo.png", width: "500" } })
        ]),
        _vm._v(" "),
        _c("div", [
          _c("div", { staticClass: "tite", attrs: { align: "center" } }, [
            _c("strong", { attrs: { align: "center" } }, [
              _vm._v("Convencidos que los mejores tiempos ")
            ]),
            _c("br"),
            _vm._v(" "),
            _c("small", { staticClass: "tite2", attrs: { align: "center" } }, [
              _vm._v("¡son estos que vivimos! ")
            ])
          ]),
          _vm._v(" "),
          _c("div", [
            _c("p", { staticStyle: { "font-size": "40px", padding: "10%" } }, [
              _vm._v(
                "    Concebimos este espacio como encuentro para el fortalecimiento de las ideas. Donde cada individuo trabaje desde sus rocas, como matriz de sus sueños.\t"
              )
            ])
          ])
        ])
      ...
      _c("p", { staticClass: "p-2" }, [
        _vm._v(
          "    En la medida vayamos compartiendo contigo, con él, con ella, con Uds, sin limitaciones de ninguna índole, alcanzaremos estadios superiores de conciencia. Capaces de innovar e inventar al mirar tus voluntades y las nuestras, entrelazadas. Conectadas para generar energías de acercamiento. Nuestra roca es la familia, albergado en un hogar más allá del ámbito físico y mental.  "
        )
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "H-Ast" }, [
        _c("b", [_vm._v("Astudillo's Group")]),
        _vm._v(
          " es la fragancia del espacio posible de ser niño aún cuando nos cubra el ropaje de adulto.\t\t\n\t"
        )
      ]),
      _vm._v(" "),
      _vm._v('"> \n\t\t\t'),
      _c("img", {
        attrs: {
          src:
            "https://viapacksur.files.wordpress.com/2013/07/100900-get-ideas-for-web-design-21.jpg",
          align: "right"
        }
      })
    ])
